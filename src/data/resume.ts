  ...
  jobs: [
    {
      ...
      description: {
        ...
        en: 'The SVOM mission consist in analyzing past stars thanks to a dedicated satellite that intercepts gamma ray bursts produced by the stars when they die. The satellite captures these rays, study them and send information about it on Earth where telescopes take over the study.',
      },
      tasks: {
        fr: "Dans le cadre de ce projet, je participe au développement du framework ANIS de mise à disposition et de visualisation de données astrophysiques, ainsi qu'au développement des modules spécifiques à la mission SVOM. Je suis aussi en charge d'augmenter la qualité logicielle, notamment en mettant en place la suite de tests unitaires pour la partie frontend sous Angular.",
        en: 'I was involved in the development of ANIS framework which is a dedicated tool to provide and visualize astrophysics data. In addition, I developed the SVOM mission specific modules. I was also in charge of improve the software quality, notably by setting up unit testing for the frontend part in Angular.',
      },
      technologies: [
        'Angular',
        'RxJS',
    ...
    },
    {
      ...
      description: {
        ...
        en: 'The Currency Shop is a comparison website for international money transfers and travel money. They provide guides, reviews and converter to find the best exchange rates.',
      },
      tasks: {
    ...
    },
    {
      ...
      tasks: {
        ...
        en: 'My main task was to rewrite the application in Angular2+ and PHP, previously in Django (Python). I had to add new features like large file size to download and add new tools in GAZPAR. I was also able to optimize the PostgreSQL database.',
      },
      technologies: [
        'Angular2',
        'Bootstrap3',
    ...
    },
    {
      ...
      tasks: {
        ...
        en: 'I worked on a PostgreSQL database conception and data migration from an Microsoft Access database. In addition I managed to store and manipulate spatial data with the PostGIS extension. Finally I built a web application that allows divers to enter new data to the database.',
      },
      technologies: [
        'PostgreSQL',
        'PostGIS',
    ...
    },
    {
      ...
      description: {
        ...
        en: 'Conception of a web application to manage IBDM publications and users preferences related to their publications. These operations were done manually before the application.',
      },
      tasks: {
        ...
        en: 'I did a web application to manage institute publications and users preferences related to their publications. These operations were done manually before the application. Made with PHP, HTML, CSS, jQuery and few plugins, this application is based on MySQL database that I built with MERISE methodology.',
      },
      technologies: [
        'MySQL',
        'MERISE',
